...
public class MyFragment extends Fragment implements View.OnClickListener {
    ...
    private void findViewById(View v) {
        ...
        String WelcomeText = "欢迎您, "+ SharedPreferencesUtils.getUserInfo(getActivity()).getName();
        ...
        if(Objects.equals(SharedPreferencesUtils.getUserInfo(getActivity()).getRole(), "user")){
            String MySecondText = getString(R.string.PrivateCoach);
            MySecondTextView.setText(MySecondText);
        }else if(Objects.equals(SharedPreferencesUtils.getUserInfo(getActivity()).getRole(), "teacher")){
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.my_first) {
            ...
            if(Objects.equals(SharedPreferencesUtils.getUserInfo(getActivity()).getRole(), "user")){
                ...
                startActivity(new Intent(getActivity(), LessonManageActivity.class).putExtra("introPoint", SharedPreferencesUtils.getUserInfo(getActivity()).getRole()));
            }
        }
    }
}
