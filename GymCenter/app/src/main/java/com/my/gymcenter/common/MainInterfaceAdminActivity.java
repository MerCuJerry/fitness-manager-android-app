...
import com.my.gymcenter.lesson.LessonAddActivity;
...
public class MainInterfaceAdminActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void findViewById() {
        ...
        findViewById(R.id.LessonAdd).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        IntroPoint.put(R.id.LessonAdd, LessonAddActivity.class);
        ...
        Intent intent=new Intent().setClass(mContext, IntroPoint.get(v.getId()));
        intent.putExtra("introPoint", SharedPreferencesUtils.getUserInfo(mContext).getRole());
